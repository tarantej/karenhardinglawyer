	...
	?>
		<div class="row">
            <div class="copyrights">
                <p><?php echo esc_html(get_theme_mod( 'kr_copyright_text', __('Copyrights Krystal. All Rights Reserved','krystal')) ); ?><span><?php esc_html_e(' | Theme by ','krystal') ?><a href="<?php echo esc_url(KRYSTAL_THEME_AUTH); ?>" target="_blank"><?php esc_html_e('Spiraclethemes','krystal') ?></a></span></p>
            </div>
        </div>
	<?php
}
