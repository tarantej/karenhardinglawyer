    ...
    if ( optionsframework_upload ) {
      ...
      optionsframework_upload.on( 'select', function() {
        ...
        if ( attachment.attributes.type == 'image' ) {
          optionsframework_selector.find('.screenshot').empty().hide().append('<img src="' + attachment.attributes.url + '"><span class="mlu_remove remove-image button"><i class="fa fa-times"></i></span>').slideDown('fast');
        }
