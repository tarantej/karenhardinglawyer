<?php
/*
Plugin Name: iMaginem Widget Set r9
...
require_once ( plugin_dir_path( __FILE__ ) . 'widgets/about-me/about-me-widget.php');
require_once ( plugin_dir_path( __FILE__ ) . 'widgets/portfolio-gallery.php');
