...
class mtheme_Popular_Posts extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('popular_posts', __('Kreativa Popular Posts', 'mthemelocal'), $widget_ops);
...
<?php if (has_post_thumbnail() ): ?>
		...
		<?php
		// Show Image
		if (function_exists('kreativa_display_post_image')) {
			echo kreativa_display_post_image (
				get_the_ID(),
				$have_image_url=false,
				$link=false,
				$type="kreativa-gridblock-tiny",
				$the_post_title="",
				$class="" 
			);
		}
