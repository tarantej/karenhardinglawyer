			...
			if (!empty($this->conditions))
			{
				foreach ($this->conditions as $condition)
				{
					...
					)
					{
						...
						$condition_output = '<div class="nmm-hidden nmm-condition" data-nmm-conditional="' . $this->id . '"' . $condition_replacement . ' data-nmm-value="' . esc_attr($condition['value']) . '" data-nmm-compare="' . esc_attr($condition['compare']) . '"></div>';
