		...
		(
			...
			(
				...
				(
					...
					. '<a href="https://robertnoakes.com/" target="_blank" rel="noopener noreferrer"><img src="' . $nmm->cache->asset_path('images', 'robert-noakes.png') . '" height="67" width="514" alt="Robert Noakes" class="robert-noakes" /></a>'
				)),
				
				new Noakes_Menu_Manager_Field_HTML(array
				(
					'content' => __('Running into issues with the plugin?', 'noakes-menu-manager') . '<br />'
					. '<a href="' . Noakes_Menu_Manager_Constants::URL_SUPPORT . '" target="_blank" rel="noopener noreferrer"><strong>' . __('Submit a ticket.', 'noakes-menu-manager') . '</strong></a>'
				)),
				
				new Noakes_Menu_Manager_Field_HTML(array
				(
					'content' => __('Have some feedback you\'d like to share?', 'noakes-menu-manager') . '<br />'
					. '<a href="' . Noakes_Menu_Manager_Constants::URL_REVIEW . '" target="_blank" rel="noopener noreferrer"><strong>' . __('Provide a review.', 'noakes-menu-manager') . '</strong></a>'
				)),
				
				new Noakes_Menu_Manager_Field_HTML(array
				(
					'content' => __('Want to see the plugin in your language?', 'noakes-menu-manager') . '<br />'
					. '<a href="' . Noakes_Menu_Manager_Constants::URL_TRANSLATE . '" target="_blank" rel="noopener noreferrer"><strong>' . __('Assist with translation.', 'noakes-menu-manager') . '</strong></a>'
				)),
				
				new Noakes_Menu_Manager_Field_HTML(array
				(
					'content' => __('Would you like to support development?', 'noakes-menu-manager') . '<br />'
					. '<a href="' . Noakes_Menu_Manager_Constants::URL_DONATE . '" target="_blank" rel="noopener noreferrer"><strong>' . __('Make a small donation.', 'noakes-menu-manager') . '</strong></a>'
				))
			)
		));
		...
		(
			...
			(
				...
				(
					...
					. '<img src="' . $nmm->cache->asset_path('images', 'YourWordPressDXP300x600.png') . '" border="0" class="nmm-banner-tall" />'
					. '<img src="' . $nmm->cache->asset_path('images', 'YourWordPressDXP728x90.png') . '" border="0" class="nmm-banner-wide" />'
					. '</a>'
				))
			)
		));
