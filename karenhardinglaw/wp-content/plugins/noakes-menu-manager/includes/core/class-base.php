...
final class Noakes_Menu_Manager extends Noakes_Menu_Manager_Wrapper
{
	...
	public function plugins_loaded()
	{
		...
		add_action('init', array($this, 'init_nav_menus'), 1000);
	...
	public function plugin_row_meta($links, $file)
	{
		...
		(
			...
			array
			(
				'<a href="' . Noakes_Menu_Manager_Constants::URL_SUPPORT . '" target="_blank" rel="noopener noreferrer">' . __('Support', 'noakes-menu-manager') . '</a>',
				'<a href="' . Noakes_Menu_Manager_Constants::URL_REVIEW . '" target="_blank" rel="noopener noreferrer">' . __('Review', 'noakes-menu-manager') . '</a>',
				'<a href="' . Noakes_Menu_Manager_Constants::URL_TRANSLATE . '" target="_blank" rel="noopener noreferrer">' . __('Translate', 'noakes-menu-manager') . '</a>',
				'<a href="' . Noakes_Menu_Manager_Constants::URL_DONATE . '" target="_blank" rel="noopener noreferrer">' . __('Donate', 'noakes-menu-manager') . '</a>'
			)
		)
		: $links;
	}
