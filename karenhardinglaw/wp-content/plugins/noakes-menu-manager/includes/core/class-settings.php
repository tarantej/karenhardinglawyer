...
final class Noakes_Menu_Manager_Settings extends Noakes_Menu_Manager_Wrapper
{
	...
	{
		do_action('np_screen_setup');
		
		add_action('admin_enqueue_scripts', array('Noakes_Menu_Manager_Global', 'admin_enqueue_scripts'), 100);
		...
		(
			...
			__('Delete Plugin Settings', 'noakes-menu-manager'),
		...
		(
			...
			__('Delete Plugin Post Meta', 'noakes-menu-manager'),
		...
		(
			...
			__('Delete Plugin User Meta', 'noakes-menu-manager'),
	...
	{
		array_unshift($links, '<a href="' . esc_url(get_admin_url(null, 'options-general.php?page=' . Noakes_Menu_Manager_Constants::OPTION_SETTINGS)) . '">' . $this->page_title . '</a>');
