...
final class Noakes_Menu_Manager_Generator extends Noakes_Menu_Manager_Wrapper
{
	...
	public function load_option($settings = null)
	{
		if (empty($settings))
		{
			$settings = get_option(Noakes_Menu_Manager_Constants::OPTION_GENERATOR);
		}
	...
	{
		array_unshift($links, '<a href="' . esc_url(get_admin_url(null, 'tools.php?page=' . Noakes_Menu_Manager_Constants::OPTION_GENERATOR)) . '">' . $this->page_title . '</a>');
