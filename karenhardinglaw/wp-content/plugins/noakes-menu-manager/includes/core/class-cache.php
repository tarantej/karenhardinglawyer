...
final class Noakes_Menu_Manager_Cache extends Noakes_Menu_Manager_Wrapper
{
	...
	public function __construct()
	{
		...
		add_filter('np_remove_query_args', array($this, 'remove_query_args'));
	}
	...
	protected function _default($name)
	{
		switch ($name)
		{
			...
			case 'current_tab':
				...
				: Noakes_Menu_Manager_Output::TAB_DEFAULT;
			...
			case 'screen':
				...
				if (strpos($screen->id, Noakes_Menu_Manager_Constants::TOKEN))
				{
					$screen->id = $screen->id . '_' . $this->current_tab;
				}
	...
	{
		return apply_filters('np_remove_query_args', array());
	}
}
