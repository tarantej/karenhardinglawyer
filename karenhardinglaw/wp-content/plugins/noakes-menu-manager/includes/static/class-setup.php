...
final class Noakes_Menu_Manager_Setup
{
	...
	public static function check_version()
	{
		$current_version =
		(
			!defined('NP_FORCE_PREVIOUS_VERSION')
			||
			!NP_FORCE_PREVIOUS_VERSION
		)
		? get_option(Noakes_Menu_Manager_Constants::OPTION_VERSION)
		: '2.0.0';

		if (empty($current_version))
		{
			add_option(Noakes_Menu_Manager_Constants::OPTION_VERSION, Noakes_Menu_Manager_Constants::VERSION);
		}
		else if ($current_version != Noakes_Menu_Manager_Constants::VERSION)
		{
			update_option(Noakes_Menu_Manager_Constants::OPTION_VERSION, Noakes_Menu_Manager_Constants::VERSION);
	...
	private static function _pre_three_zero_zero($nmm, $current_version)
	{
		...
		$plugin_settings = Noakes_Menu_Manager_Utilities::check_array(get_option(Noakes_Menu_Manager_Constants::OPTION_SETTINGS));
	...
	{
		$generator_settings = Noakes_Menu_Manager_Utilities::check_array(get_option(Noakes_Menu_Manager_Constants::OPTION_GENERATOR));
