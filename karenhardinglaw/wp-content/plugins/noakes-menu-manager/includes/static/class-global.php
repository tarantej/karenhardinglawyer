...
final class Noakes_Menu_Manager_Global
{
	 ...
	 * @var string
	 */
	const JQUERY_VALIDATE_VERSION = '1.19.2';
	...
	public static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_script('nmm-script', $nmm->cache->asset_path('scripts', 'script.js'), array('jquery-ui-sortable', 'noatice', 'postbox', 'wp-util', 'jquery-validation'), Noakes_Menu_Manager_Constants::VERSION, true);
