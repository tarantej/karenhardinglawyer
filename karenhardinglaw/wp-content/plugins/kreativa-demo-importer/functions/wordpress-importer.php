...
<?php
	...
	function process_menu_item( $item ) {
		...
		$field_name_prefix = array( 'menu-item-megamenu', 'menu-item-megamenu-layout', 'menu-item-enable-textbox', 'menu-item-textbox', 'mega-menu-columns' );

		$id = wp_update_nav_menu_item( $menu_id, 0, $args );

		foreach ( $field_name_prefix as $prefix ) {
			$mega_key = $prefix . '-' . $id;
			$mega_value = $prefix . '-' . $item['post_id'];
			if ( isSet( $$mega_value ) ) {
				update_post_meta( $id, $mega_key, $$mega_value );
			}
		}
