...
function mtheme_enable_story_sort() {
    add_submenu_page('edit.php?post_type=mtheme_featured', 'Sort Fullscreen', 'Sort Fullscreen', 'edit_posts', basename(__FILE__), 'mtheme_sort_fullscreen');
}
...
function mtheme_sort_fullscreen() {
	$gallery = new WP_Query('post_type=mtheme_featured&posts_per_page=-1&orderby=menu_order&order=ASC');
?>
	<div class="wrap">
